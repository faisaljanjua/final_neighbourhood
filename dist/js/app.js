...
function setContent(id, marker) {
    ...
    var url = 'https://api.foursquare.com/v2/venues/' + id +
        '?client_id=JTPVQE4CDRIR0DFXAKDLZ3LHNAOWFLUGMNL2UCHQOXU0VRUE&client_secret=OEYN0XBBIEGYWMDA0DVJZT0VMNYZC0C231IRW2OOTGSNY1SC&v=20130815';
    $.getJSON(url, function (data) {
        ...
        self.name = data.response.venue.name;
        ...
        self.content = "<h5>" + self.name + "</h5>" +
            "<div id='iwpic'><img src=" + self.photoPrefix + "110x110" + self.photoSuffix + " alt=''> </div>" +
            "<h6 style='margin-bottom:0px;'> Rating </h6>" + self.rating +
            "<h6 style='margin-bottom:0px;'> TimeZone </h6>" + self.timezone +
            "<p><ul class='list-inline'><li><a href='https://www.twitter.com/" + self.twitter + "' target='_blank'><img src='img/twitter.png'></a></li>" +
            "<li><a href='http://www.facebook.com/" + self.facebook + "' target='_blank'><img src='img/facebook.png'></a></li></p>" +
